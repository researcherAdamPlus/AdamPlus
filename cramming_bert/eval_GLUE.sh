...
# crammed BERT
for i in 1 2 3 4; do
    CUDA_VISIBLE_DEVICES=2 python eval.py eval=GLUE_sane name=bert-finetuning-adamw+ eval.checkpoint=hf://bert-base-uncased impl.shuffle_in_dataloader=True impl.compile_torch=False impl.microbatch_size=16
done
